...
export const teamInfo = [
  ...
  {name: 'Maksim Siomak', img: `${maximImg}`, socialLink: 'https://github.com/Pleomax07', teamRole: 'Developer',},
  {name: 'Evgeniy Zyuskin', img: `${evgeniyImg}`, socialLink: 'https://github.com/Yevhenns', teamRole: 'Developer',},
  {name: 'Yelyzaveta Demchenko', img: `${yelyzavetaImg}`, socialLink: 'https://github.com/yelyzaveta05', teamRole: 'Developer',},
  {name: 'Artem Borzov', img: `${artemImg}`, socialLink: 'https://github.com/Artem-Borzov', teamRole: 'Developer',},
  {name: 'Yurii Shulga', img: `${yuriiImg}`, socialLink: 'https://github.com/Yurkes2020', teamRole: 'Developer',},
];